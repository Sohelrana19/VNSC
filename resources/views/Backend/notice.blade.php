              ...
              <div class="iq-card-body">
               <div id="table" class="table-editable">
                 ...
                 <table id="example" class="table table-bordered table-responsive-md table-striped text-center">
                   ...
                   <tbody>
                    @foreach ($allData as $kye => $notice )
                    <tr>
                      <td >{{$kye+1}}</td>
                      <td >{{$notice->title}}</td>
                      <td ><img src="{{URL::to($notice->imagePath)}}" alt="" style="width: 150px; height:150px"></td>
                      <td >{!!$notice->description!!}</td>
                      <td>
                            <div class="flex align-items-center list-user-action">
                            <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{route('notice.edit',$notice->id)}}"><i class="ri-pencil-line"></i></a>
                               <a id="delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="{{route('notice.delet',$notice->id)}}"><i class="ri-delete-bin-line"></i></a>
                            </div>
                         </td>
                    </tr>
                    @endforeach
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="iq-card">
                <div class="iq-card-body">
                   <form  method="POST" action="{{route('notice.store')}}" id="myForm" enctype="multipart/form-data">
                    @csrf
                      <div class="form-row">
