        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/Pic College14.png')}}"  class="img-fulid w-100" alt="">

                    <div class="InfrastructureDetail">
                        <h3>Number of Academic Building</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/Pic College3.png')}}"  class="img-fulid w-100" alt="">
            ...
            <div class="col-lg-4">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/Pic College8.png')}}"  class="img-fulid w-100" alt="">
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/Pic College4.png')}}"  class="img-fulid w-100" alt="">
            ...
            <div class="col-lg-8">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/PPIMSC.png')}}"  class="img-fulid w-100" alt="">
...
<section id="infrastructure">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/boysbuilding.jpg')}}"  class="img-fulid w-100" alt="">

                    <div class="InfrastructureDetail">
                        <h3>Boys Hostel Building</h3>
            ...
            <div class="col-lg-4">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/girls building.jpg')}}"  class="img-fulid w-100" alt="">

                    <div class="InfrastructureDetail">
                        <h3>Girls Hostel Building</h3>
            ...
            <div class="col-lg-4">
                <div class="infrastructure">
                    <img src="{{ asset('public/Fontend/image/Infrastructure/Principal Quarter.JPG')}}"  class="img-fulid w-100" alt="">

                    <div class="InfrastructureDetail">
                        <h3>Principal Quarter Building</h3>
